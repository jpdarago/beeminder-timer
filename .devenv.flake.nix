{
  inputs =
    let
      version = "1.10.0";
system = "x86_64-linux";
devenv_root = "/home/jp/code/beeminder-timer";
devenv_dotfile = "/home/jp/code/beeminder-timer/.devenv";
devenv_dotfile_path = ./.devenv;
devenv_tmpdir = "/run/user/1000";
devenv_runtime = "/run/user/1000/devenv-7029eb8";
...
hostname = "homura";
username = "jp";
git_root = "/home/jp/code/beeminder-timer";
